...
@NgModule({ declarations: [ComidasPorCategoriaPage], imports: [CommonModule,
        FormsModule,
        IonicModule,
        ComidasPorCategoriaPageRoutingModule], providers: [provideHttpClient(withInterceptorsFromDi())] })
