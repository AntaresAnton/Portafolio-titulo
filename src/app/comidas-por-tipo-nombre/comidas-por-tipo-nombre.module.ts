...
@NgModule({ declarations: [ComidasPorTipoNombrePage], imports: [CommonModule,
        FormsModule,
        IonicModule,
        ComidasPorTipoNombrePageRoutingModule], providers: [provideHttpClient(withInterceptorsFromDi())] })
