...
@NgModule({ declarations: [ComidasPorPaisNombrePage], imports: [CommonModule,
        FormsModule,
        IonicModule,
        ComidasPorPaisNombrePageRoutingModule], providers: [provideHttpClient(withInterceptorsFromDi())] })
