...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./comidas-por-pais-nombre/comidas-por-pais-nombre.module').then(m => m.ComidasPorPaisNombrePageModule),
    canActivate: [AuthGuard]
  },
  {
    path: 'comidas-por-tipo',
    loadChildren: () => import('./comidas-por-tipo/comidas-por-tipo.module').then( m => m.ComidasPorCategoriaPageModule),
    canActivate: [AuthGuard]
  },
  {
    path: 'comidas-por-tipo-nombre/:nombre',
    loadChildren: () => import('./comidas-por-tipo-nombre/comidas-por-tipo-nombre.module').then(m => m.ComidasPorTipoNombrePageModule),
    canActivate: [AuthGuard]
  },
  {
